...
urlpatterns = patterns('',
    ...
    url(r'^weather_alerts/all/$', 'wxwarn.views.weather_alerts_all', name='weather_alerts_all'),
    url(r'^weather_alerts/(?P<state_code>[a-z]{2})/$', 'wxwarn.views.weather_alerts_state', name='weather_alerts_state'),
