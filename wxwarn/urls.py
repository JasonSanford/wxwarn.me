...
urlpatterns = patterns('',
    ...
    url(r'^login_error/$', 'wxwarn.views.login_error', name='login_error'),
    url(r'^logout/$', 'wxwarn.views.logout', name='logout'),
    url(r'^user/$', 'wxwarn.views.account_landing', name='account_landing'),
    url(r'^user/my_weather_alerts/$', 'wxwarn.views.user_weather_alerts', name='user_weather_alerts'),
    ...
    url(r'^user/activate_deactivate/$', 'wxwarn.views.account_activate_deactivate', name='activate_deactivate'),
