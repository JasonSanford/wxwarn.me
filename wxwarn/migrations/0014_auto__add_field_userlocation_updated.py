...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserLocation.updated'
        db.add_column('wxwarn_userlocation', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserLocation.updated'
        db.delete_column('wxwarn_userlocation', 'updated')
