...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserWeatherAlert.weather_alert_location_id'
        db.alter_column('wxwarn_userweatheralert', 'weather_alert_location_id', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

    def backwards(self, orm):

        # Changing field 'UserWeatherAlert.weather_alert_location_id'
        db.alter_column('wxwarn_userweatheralert', 'weather_alert_location_id', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))
