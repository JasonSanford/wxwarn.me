...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserLocation.latitude'
        db.delete_column('wxwarn_userlocation', 'latitude')

        # Deleting field 'UserLocation.longitude'
        db.delete_column('wxwarn_userlocation', 'longitude')

        # Adding field 'UserLocation.geometry'
        db.add_column('wxwarn_userlocation', 'geometry',
                      self.gf('django.db.models.fields.TextField')(default='{"type": "Point", "coordinates": [0, 0]}'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserLocation.latitude'
        db.add_column('wxwarn_userlocation', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'UserLocation.longitude'
        db.add_column('wxwarn_userlocation', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'UserLocation.geometry'
        db.delete_column('wxwarn_userlocation', 'geometry')
