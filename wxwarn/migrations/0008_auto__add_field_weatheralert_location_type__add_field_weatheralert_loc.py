...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeatherAlert.location_type'
        db.add_column('wxwarn_weatheralert', 'location_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['wxwarn.LocationType']),
                      keep_default=False)

        # Adding field 'WeatherAlert.location_ids'
        db.add_column('wxwarn_weatheralert', 'location_ids',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WeatherAlert.location_type'
        db.delete_column('wxwarn_weatheralert', 'location_type_id')

        # Deleting field 'WeatherAlert.location_ids'
        db.delete_column('wxwarn_weatheralert', 'location_ids')
