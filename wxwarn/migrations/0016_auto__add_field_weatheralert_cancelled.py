...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeatherAlert.cancelled'
        db.add_column('wxwarn_weatheralert', 'cancelled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WeatherAlert.cancelled'
        db.delete_column('wxwarn_weatheralert', 'cancelled')
