...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Marine.geometry_bbox'
        db.add_column('wxwarn_marine', 'geometry_bbox',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'County.geometry_bbox'
        db.add_column('wxwarn_county', 'geometry_bbox',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'UGC.geometry_bbox'
        db.add_column('wxwarn_ugc', 'geometry_bbox',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Marine.geometry_bbox'
        db.delete_column('wxwarn_marine', 'geometry_bbox')

        # Deleting field 'County.geometry_bbox'
        db.delete_column('wxwarn_county', 'geometry_bbox')

        # Deleting field 'UGC.geometry_bbox'
        db.delete_column('wxwarn_ugc', 'geometry_bbox')
