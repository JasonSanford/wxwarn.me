...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserLocationStatus'
        db.create_table('wxwarn_userlocationstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('location_status', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('wxwarn', ['UserLocationStatus'])


    def backwards(self, orm):
        # Deleting model 'UserLocationStatus'
        db.delete_table('wxwarn_userlocationstatus')
