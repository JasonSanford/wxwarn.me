...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarineZone'
        db.create_table('wxwarn_marinezone', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('codes', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('wxwarn', ['MarineZone'])
        from django.core.management import call_command
        call_command('loaddata', '0003_initial_marinezone.json')


    def backwards(self, orm):
        # Deleting model 'MarineZone'
        db.delete_table('wxwarn_marinezone')
