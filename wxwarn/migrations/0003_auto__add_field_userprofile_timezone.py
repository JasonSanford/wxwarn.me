...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('wxwarn_userprofile', 'timezone',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=18, to=orm['wxwarn.Timezone']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.timezone'
        db.delete_column('wxwarn_userprofile', 'timezone_id')
