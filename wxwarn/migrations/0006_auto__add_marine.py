...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('wxwarn_marine', (
            ...
            ('wfo', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('geometry', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('wxwarn', ['Marine'])


    def backwards(self, orm):
        # Deleting model 'Marine'
        db.delete_table('wxwarn_marine')
