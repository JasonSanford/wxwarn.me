...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserWeatherAlert.weather_alert_ugc'
        db.delete_column('wxwarn_userweatheralert', 'weather_alert_ugc')

        # Adding field 'UserWeatherAlert.weather_alert_location_id'
        db.add_column('wxwarn_userweatheralert', 'weather_alert_location_id',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'UserWeatherAlert.weather_alert_ugc'
        raise RuntimeError("Cannot reverse this migration. 'UserWeatherAlert.weather_alert_ugc' and its values cannot be restored.")
        # Deleting field 'UserWeatherAlert.weather_alert_location_id'
        db.delete_column('wxwarn_userweatheralert', 'weather_alert_location_id')
    ...
    models = {
        ...
        'wxwarn.userweatheralert': {
            ...
            'weather_alert_location_id': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True'})
        },
