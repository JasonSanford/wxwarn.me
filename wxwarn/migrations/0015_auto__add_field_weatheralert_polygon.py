...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeatherAlert.polygon'
        db.add_column('wxwarn_weatheralert', 'polygon',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WeatherAlert.polygon'
        db.delete_column('wxwarn_weatheralert', 'polygon')
